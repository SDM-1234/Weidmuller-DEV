report 16402 "GSTR-1"
{
    ...
    dataset
    {
        dataitem(DataItem1500000; Table2000000026)
        {
        ...
        dataitem(DataItem1500137; Table16419)
        {
    ...
    local procedure AssignGSTAmt(DetailedGSTLedgerEntry1: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; var GSTBaseAmt: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    var
    ...
    local procedure TaxableB2B(DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    var
    ...
    local procedure TaxableB2C(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    begin
        WITH DetailedGSTLedgerEntry DO
    ...
    local procedure TaxableB2CWithLimit(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    begin
        WITH DetailedGSTLedgerEntry DO
    ...
    local procedure NilRatedExempted(DetailedGSTLedgerEntry: Record "16419"; var GoodService: Text; var Exempted: Decimal; ItemNo: Code[20])
    var
    ...
    local procedure NilRatedNonGST(DetailedGSTLedgerEntry: Record "16419"; var GoodService: Text; var NonGST: Decimal; ItemNo: Code[20])
    var
        DetailedGSTLedgerEntry1: Record "16419";
    begin
        GetGoodsAndService(DetailedGSTLedgerEntry, GoodService);
    ...
    local procedure DetailsCreditAndDebit(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    begin
        AssignGSTAmt(
          DetailedGSTLedgerEntry, GSTCompRate1, GSTCompRate2, GSTCompRate3,
    ...
    local procedure SuppliesExported(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; var DocNo: Code[20]; var PostingDate: Date; var HSNCode: Code[10]; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10]; ExpNo: Code[20]; ExpDate: Date)
    begin
    ...
    local procedure AdvancePaymentAfterPosting(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    begin
        WITH DetailedGSTLedgerEntry DO BEGIN
            AssignGSTAmt(
              DetailedGSTLedgerEntry, GSTCompRate1, GSTCompRate2, GSTCompRate3, GSTCompAmt1,
    ...
    local procedure AdvancePaymentBeforePosting(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    begin
        AssignGSTAmt(
    ...
    local procedure AdvancePaymentAdjustmentJnl(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    var
        Customer: Record "18";
    begin
        WITH DetailedGSTLedgerEntry DO
    ...
    local procedure SuppliesUnregCustThroughECom(var DetailedGSTLedgerEntry: Record "16419"; var GSTCompRate1: Decimal; var GSTCompRate2: Decimal; var GSTCompRate3: Decimal; var GSTCompAmt1: Decimal; var GSTCompAmt2: Decimal; var GSTCompAmt3: Decimal; GSTComp1: Code[10]; GSTComp2: Code[10]; GSTComp3: Code[10])
    begin
        WITH DetailedGSTLedgerEntry DO BEGIN
            SNo += 1;
            AssignGSTAmt(
    ...
    local procedure FilterPostingDate(var DetailedGSTLedgerEntry: Record "16419")
    begin
        WITH DetailedGSTLedgerEntry DO
            CASE Period OF
                Period::Jan:
    ...
    local procedure GetGoodsAndService(var DetailedGSTLedgerEntry: Record "16419"; var GoodService: Text)
    var
        Item: Record "27";
        GLAccount: Record "15";
