report 50003 "Purchase Order"
{
    ...
    //  |ZE    |         |16.06.20|ZE_Kajal |Kajal    | Changes in Layout "Description" Field Size adjusted for data.                                       |
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table38)
        {
            ...
            column(ReferenceNoCaption; ReceivingNoCaption)
            {
            }
            column(Reference_No; "Purchase Header"."Receiving No.")
            {
            }
    ...
    var
        ...
        text001: Label 'The prices committed on this purchase order will remain firm, till the full execution of the order.';
        ...
        Shipmentcode: Text;
        text004: Label 'HSN Code is mandatory in the invoice.';
        ...
        GSTAmt: Decimal;
        LnTotal: Decimal;
        ReceivingNoCaption: Label 'Reference No.';
}
