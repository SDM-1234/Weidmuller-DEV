report 50023 "Posted Sales Inv Cert."
{
    ...
    // 4|                |26.08.19|ZE_LIJO  |LIJO     |Code to Display Customer PO No.
    // 5|                |15.06.20|ZE_Kajal |Kajal    |Code to Print(Repo - Posted sales Inv Cret.)PSI ID- 300919
    DefaultLayout = RDLC;
    RDLCLayout = './PostedSalesInvCert.rdlc';
